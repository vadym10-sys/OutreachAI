...
class Settings(BaseSettings):
    ...
    ai_memory_default_enabled: bool = True
    ...
    backup_provider: str = ""
    backup_bucket: str = ""
    backup_prefix: str = "outreachai/postgres"
    backup_local_dir: str = "/tmp/outreachai-backups"
    backup_retention_days: int = 30
    backup_retention_count: int = 30
    backup_encryption_key: str = ""
    backup_restore_test_database_url: str = ""
