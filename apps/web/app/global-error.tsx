      ...
      <body>
        <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10">
          <section className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 text-center shadow-soft">
            ...
            <Link href="/sign-in" className="focus-ring mt-5 inline-flex min-h-11 items-center justify-center rounded-md bg-ink px-4 py-2 text-sm font-semibold text-white">{t("common.signInAgain")}</Link>
          </section>
        </main>
      </body>
    </html>
