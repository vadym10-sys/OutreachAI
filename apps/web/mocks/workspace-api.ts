...
export async function mockWorkspaceApi(page: Page, overrides: Record<string, MockOverride> = {}) {
  ...
  await page.route("**/api/**", async (route) => {
    ...
    if (apiPath === "/api/billing/plans" || apiPath === "/api/billing/plan-catalog") return fulfillJson(route, [
      { name: "Starter", price: 49, monthly_price: 49, currency: "EUR", billing_period: "monthly", trial_days: 14, limits: { mrr: 49, leads: 500, ai_generations: 1000, email_sends: 1000, sales_employees: 1, workspaces: 1, team_members: 1, campaigns: 3, review_mode: true, semi_auto_mode: false, autonomous_mode: false, basic_analytics: true, advanced_analytics: false, reply_ai: false, api_access: false, webhooks: false, white_label: false }, features: { manual_approval: true, basic_analytics: true }, reserved_features: { api_access: "reserved", webhooks: "reserved", white_label: "reserved" }, upgrade_to: ["Pro", "Agency"], downgrade_to: [], current: true, active_subscription: true },
      { name: "Pro", price: 149, monthly_price: 149, currency: "EUR", billing_period: "monthly", trial_days: 14, limits: { mrr: 149, leads: 5000, ai_generations: 10000, email_sends: 10000, sales_employees: 3, workspaces: 3, team_members: 10, campaigns: 25, review_mode: true, semi_auto_mode: true, autonomous_mode: false, basic_analytics: true, advanced_analytics: true, reply_ai: true, api_access: false, webhooks: false, white_label: false }, features: { manual_approval: true, semi_auto_mode: true, advanced_analytics: true, reply_ai: true }, reserved_features: { api_access: "reserved", webhooks: "reserved", white_label: "reserved" }, upgrade_to: ["Agency"], downgrade_to: ["Starter"], current: false, active_subscription: true },
      { name: "Agency", price: 499, monthly_price: 499, currency: "EUR", billing_period: "monthly", trial_days: 14, limits: { mrr: 499, leads: 50000, ai_generations: 100000, email_sends: 100000, sales_employees: 10, workspaces: 0, team_members: 0, campaigns: 0, review_mode: true, semi_auto_mode: true, autonomous_mode: true, basic_analytics: true, advanced_analytics: true, reply_ai: true, api_access: true, webhooks: true, white_label: true }, features: { manual_approval: true, semi_auto_mode: true, autonomous_mode: true, advanced_analytics: true, reply_ai: true }, reserved_features: { api_access: "reserved", webhooks: "reserved", white_label: "reserved" }, upgrade_to: [], downgrade_to: ["Starter", "Pro"], current: false, active_subscription: true }
    ]);
    if (apiPath === "/api/billing/status") return fulfillJson(route, { plan: "Starter", price: 49, status: "active", trial_days_remaining: 14, limits: { leads: 500, email_sends: 1000, ai_generations: 1000, sales_employees: 1, workspaces: 1, team_members: 1, campaigns: 3 }, usage: { leads: 1, email_sends: 0, ai_generations: 3 }, sales_employees_used: 0, workspaces_used: 1 });
