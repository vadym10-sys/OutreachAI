...
export const firstCustomerResultSchema = z.object({
  ...
  observed_fact: z.string().optional(),
  model_inference: z.string().optional(),
  fit_explanation: z.string().optional(),
  ai_relevance_score: z.number(),
  confidence_score: z.number(),
  verified_status: z.string(),
  result_tier: z.string().optional(),
  website_verification_status: z.string().optional(),
  website_verification_warning: z.string().optional(),
  missing_buying_signal: z.boolean().optional(),
  checked_at: z.string(),
  ...
  overall_lead_score: z.number().optional(),
  growth_signal_score: z.number().optional(),
  hiring_signal_score: z.number().optional(),
  funding_signal_score: z.number().optional(),
  expansion_signal_score: z.number().optional(),
  website_quality_score: z.number().optional(),
  technology_fit_score: z.number().optional(),
  contact_confidence_score: z.number().optional(),
  outreach_readiness_score: z.number().optional(),
  company_momentum_score: z.number().optional(),
  ...
  outreach_strategy: z.record(z.unknown()).optional(),
...
export const outreachSenderStatusSchema = z.object({
  ...
  oauth_connected: z.boolean().optional(),
  oauth_status: z.string().optional(),
  oauth_mailbox: z.string().nullable().optional(),
  oauth_connected_at: z.string().optional(),
  oauth_scopes: z.array(z.string()).optional(),
  oauth_start_ready: z.boolean().optional(),
  oauth_start_status: z.string().optional(),
  oauth_start_reason: z.string().optional(),
  spf_status: z.string(),
...
export const billingStatusSchema = z.object({
  ...
  entitlement_source: z.string().optional(),
  test_entitlement: z.boolean().optional(),
  entitlement_expires_at: z.string().nullable().optional(),
