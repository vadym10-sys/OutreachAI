...
export const firstCustomerResultSchema = z.object({
  ...
  source_confidence: z.number().optional(),
  source_verification_status: z.string().optional(),
  fit_explanation: z.string().optional(),
  ai_relevance_score: z.number(),
  icp_fit_score: z.number().optional(),
  buying_intent_score: z.number().optional(),
  revenue_opportunity_score: z.number().optional(),
  ...
  score_factors: z.record(z.unknown()).optional(),
  score_weights: z.record(z.unknown()).optional(),
  score_penalties: z.record(z.unknown()).optional(),
  ...
  email_delivery_status: z.string().optional(),
  can_send: z.boolean().optional(),
  lead_status: z.string().optional(),
  simple_status: z.string().optional()
}).passthrough();
