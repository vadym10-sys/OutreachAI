...
| Dashboard | Show the next best action and core results. | Customer | Keep as command center. Add guided first-success path. |
| Leads | Find and review companies. | Customer | Keep as primary work page. |
...
| Billing | Manage plan, usage, and payment. | Customer | Keep. It supports conversion and trust. |
...
| Owner Console | Owner-only company control plane. | Owner | Keep hidden and backend-protected. |
| Error / Empty states | Recover and guide next action. | Everyone | Keep improving. Never show raw technical failures. |

## Prioritized Improvements

1. Make the dashboard show one first-success workflow from signup to results.
...
6. Keep Lead Finder to three default fields with advanced filters hidden.
